...
// Profiles with background removal (compact WebP) + Reset + global sound toggle

import { createCutoutFromImage, downscaleImageToDataURL } from "./segmentation.js";
import { playPlop, playBoing, initSoundToggle } from "./sound.js";
...
function saveProfiles(list){
  try {
    ...
    // free space: drop originals if needed
